...
export default function DTechnology() {
    const [News, setNews] = useState([])
    const [News2, setNews2] = useState([])

    useEffect(() => {
        axios
            .get(`${process.env.REACT_APP_API_URL}en/json/file/generateCategory7.json`)
            .then(({ data }) => {
                setNews(data.data[0])
        ...
        <>
            ...
            <div className="common-post-listBox">
                <div className="section-heading">
                    <Link to="/english/technology" onClick={scrollTop}>
                        <h2>Technology</h2>
                    </Link>
                </div>
                <div className="common-single-post-wrap">
                    {News ?
                        <Link to={"/english/" + News.Slug + "/news/" + News.ContentID} onClick={scrollTop}>
                            ...
                            <div className="Desc">
                                <h3 className="Title">{News.ContentSubHeading ? (News.ContentSubHeading + "/english/" + News.ContentHeading) : (News.ContentHeading)}
                                </h3>
                                ...
                                <Link to={"/english/" + nc.Slug + "/news/" + nc.ContentID} onClick={scrollTop}>
                                    <div className="row gx-3">
                                        ...
                                        <div className="col-7 col-lg-8">
                                            <div className="Desc">
                                                <h3 className="Title">{nc.ContentSubHeading ? (nc.ContentSubHeading + "/english/" + nc.ContentHeading) : (nc.ContentHeading)}
                                                </h3>
                                                <div className="news-Time">
