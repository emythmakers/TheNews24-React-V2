...
export default function Religion() {
    ...
    useEffect(() => {
        axios
            .get(`${process.env.REACT_APP_API_URL}json/file/generateCategory21.json`)
            .then(({ data }) => {

                setReligion(data.data.slice(0, 1))
                setReligion2(data.data.slice(1, 4))
    ...
    return (
        <>
            <div className="SectionTitle"><h3><Link to="/religion"><span className="ColorBox"></span>ধর্ম ও জীবন</Link></h3></div>
